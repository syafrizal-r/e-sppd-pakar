            ...
            <div class="card-body">
                <form action="{{ route('pegawai.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Contoh: Ir. Fulan, M.Si" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pangkat" class="form-control" placeholder="Contoh: Penata Tingkat I" required>
                    </div>
                    <div class="row">
                        <div class="col-6 mb-3">
                            <label class="form-label fw-semibold">Golongan</label>
                            <input type="text" name="golongan" class="form-control" placeholder="Contoh: III/d" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label class="form-label fw-semibold">Jabatan</label>
                            <input type="text" name="jabatan" class="form-control" placeholder="Contoh: Kepala Seksi..." required>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary w-100 fw-bold"><i class="bi bi-save"></i> Simpan Data</button>
                </form>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('pegawai.destroy', $row->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pegawai ini?')">
                                        @csrf
                                        @method('DELETE')
